...
import com.coderops.mmeter.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                com.coderops.ui.home.R.id.homeFragment,
                com.coderops.ui.home.R.id.searchFragment,
                com.coderops.ui.home.R.id.tvFragment,
                com.coderops.ui.home.R.id.profileFragment -> showBottomNav()
