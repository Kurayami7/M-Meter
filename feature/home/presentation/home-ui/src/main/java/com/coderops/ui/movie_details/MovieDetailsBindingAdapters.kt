...
import com.coderops.ui.home.databinding.GenereChipBinding
...
fun ChipGroup.setGenresMovieDetails(
    ...
    items?.forEach { genre ->
        ...
        chip.setTextColor(getResources().getColor(com.coderops.bases.R.color.on_background_38))
        chip.setText(genre)
        ...
        val chipDrawable = ChipDrawable.createFromAttributes(
            ...
            null,
            0,
            com.coderops.bases.R.style.MediaDetailsChipStyle
        )
...
fun ChipGroup.setGenreChips(
    ...
    for (chipUiState in chips) {
        val binding = DataBindingUtil.inflate<GenereChipBinding>(
            inflater,
            com.coderops.ui.home.R.layout.genere_chip,
            this,
            false
        )
