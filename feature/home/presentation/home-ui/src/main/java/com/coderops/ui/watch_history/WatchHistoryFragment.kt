...
import com.coderops.ui.common.base.SwipeToDeleteItem
import com.coderops.ui.home.R
import com.coderops.ui.home.databinding.FragmentWatchHistoryBinding
import com.coderops.viewmodel.watch_history.WatchHistoryViewModel
...
class WatchHistoryFragment
    ...
    private fun setupSnackBar(): Snackbar {
        return Snackbar.make(
            binding.root,
            getString(com.coderops.bases.R.string.item_deleted),
            ...
            .setActionTextColor(
                ContextCompat.getColor(
                    requireContext(),
                    com.coderops.bases.R.color.orangeRed
                )
            )
            .addCallback(setupSnackBarCallback())
            .setAction(getString(com.coderops.bases.R.string.undo)) {
